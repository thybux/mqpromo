...
<div class="mqpromo-container">
  ...
  <div class="mqpromo-carousel-wrapper">
    <div class="mqpromo-carousel" id="mqpromo-carousel">
      {foreach from=$promotional_products item=product name=promoloop}
  ...
  <div class="mqpromo-dot-indicators" id="mqpromo-dots">
    {* Les points indicateurs seront générés par JavaScript *}
  </div>
</div>

{* Script pour le carrousel, à placer en bas de page *}
